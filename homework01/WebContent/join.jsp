...
<body>
   ...
   <form action="joinOk.jsp" name="joinForm" method="post">
      ...
      <label>
         아이디 찾기 <input type="text" name="findId" placeholder="핸드폰 번호를 작성해주세요.">
         <input type="button" value="클릭" onclick="findId()">
      </label>
...
function send(){
   ...
   /* ajax는 파라미터로 전달한다. */
   $.ajax({
      url: "checkId.jsp", //checkId_ajax.jsp 파일을 실행한다. 출력값은 true또는 false이다.
      type: "get",
      data: "userId=" + $value,
